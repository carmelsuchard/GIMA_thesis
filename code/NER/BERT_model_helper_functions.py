...
def compute_ner_metrics(doc_predictions, doc_labels, id2label):
    print("\n Computing metrics...")
    doc_predictions = {int(k): v for k, v in doc_predictions.items()}
    doc_labels = {int(k): v for k, v in doc_labels.items()}
